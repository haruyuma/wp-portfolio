			...
			<div class="container">
			  ...
			  <div class="collapse navbar-collapse" id="navbarSupportedContent">
			    <ul class="navbar-nav ml-auto">
			      ...
			      <li class="nav-item">
			        <a class="nav-link" href="#" data-scroll-nav="2">Achievement</a>
			      <li class="nav-item">
    	...
    	<header class="header valign bg-img" data-scroll-index="0" data-overlay-dark="5" data-background="<?php echo get_template_directory_uri(); ?>/img/bg1.jpg" data-stellar-background-ratio="0.5">
    		...
    		<div class="container">
              ...
              <h1 class="cd-headline clip">
                  <span class="blc">トモカズと申します</span>
              </h1>
              <a href="#0" class="butn mt-30" data-scroll-nav="6">お問い合わせ</a>
    				</div>
    			</div>
    		</div>
    	</header>
